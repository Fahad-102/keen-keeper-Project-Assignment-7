            ...
            <div className='bg-base-300 p-6 rounded-3xl'>
                <div className='grid grid-cols-4 grid-rows-auto gap-4'>
                    ...
                    <div className='bg-white shadow-sm col-span-3 rounded-2xl p-6'>
                        ...
                        <div className='text-[16px]'>Connect Every <span className='font-bold text-green-800'>{friend.goal} Days</span></div>
                    </div>
                    ...
                    <div className="grid grid-row-3 gap-3">
                        ...
                        <Link to={"/"} className="rounded-xl bg-white text-red-600 shadow-sm flex justify-center items-center font-semibold p-3 hover:bg-red-50">
                    ...
                    <div className='bg-white col-span-3 rounded-2xl p-6 shadow-sm'>
                        ...
                        <div className='grid grid-cols-3 gap-4'>
                            <button className='btn btn-ghost bg-base-300 h-24 flex flex-col gap-2' onClick={() => handleAddEvent('Call', <LuPhoneCall/>)}>
                                <LuPhoneCall size={24}/>Call
                            </button>

                            <button className='btn btn-ghost bg-base-300 h-24 flex flex-col gap-2' onClick={() => handleAddEvent('Text', <MdOutlineTextsms/>)}>
                                <MdOutlineTextsms size={24}/>Text
                            </button>

                            <button className='btn btn-ghost bg-base-300 h-24 flex flex-col gap-2' onClick={() => handleAddEvent('Video', <LuVideo />)}>
                                <LuVideo size={24}/>Video
                            </button>
                        </div>
                    </div>
